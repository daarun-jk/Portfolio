...
// 		<div className={`w-full font-fira text-black dark:text-white text-right float-right`}>
...
// 			<div className="mt-4 p-5 font-medium bg-slate-200 dark:bg-slate-800 font-poppins h-fit">
// 				{props.description}
// 				<br></br>
// 				<br></br>
// 				<br></br>
...
// 		</div>
// 	) : (
// 		<div className={`w-full font-fira text-black dark:text-white float-left text-left`}>
// 			{/* <p className="text-xs text-sky-500">Featured Project</p> */}
// 			<h1 className="text-2xl font-bold font-poppins">{props.title}</h1>
// 			<p className="mt-1 text-sm">{props.company}</p>
// 			<div className="mt-4 p-5 font-medium bg-slate-200 dark:bg-slate-800 font-poppins h-fit">
